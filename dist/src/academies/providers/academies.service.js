...
const uploads_service_1 = require("../../uploads/providers/uploads.service");
let AcademiesService = class AcademiesService {
    ...
    uploadsService;
    constructor(academyRepository, stylesService, paginationProvider, createAcademyProvider, uploadsService) {
    ...
    async findAll(postQuery, options) {
        const academies = await this.paginationProvider.paginateQuery({ limit: postQuery.limit, page: postQuery.page }, this.academyRepository, options);
        return academies;
    }
