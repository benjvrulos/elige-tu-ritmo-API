...
let UsersService = class UsersService {
    ...
    constructor(usersRepository, authService, profileConfiguration, createUserProvider, findOneUserByEamilProvider, findOneByGoogleIdProvider, createGoogleUserProvider) {
