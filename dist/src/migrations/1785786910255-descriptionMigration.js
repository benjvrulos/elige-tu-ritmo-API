...
exports.DescriptionMigration1785786910255 = void 0;
class DescriptionMigration1785786910255 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "comuna" ("comuna_id" SERIAL NOT NULL, "name" character varying NOT NULL, "region_id" integer NOT NULL, CONSTRAINT "PK_206224a6bb3fe8b7cc91c59d0f5" PRIMARY KEY ("comuna_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "academy" ("academy_id" SERIAL NOT NULL, "name" character varying(512) NOT NULL, "description" character varying(1024) NOT NULL, "location" character varying(1024) NOT NULL, "phone" character varying(512), "website_url" character varying(1024), "instagram_url" character varying(1024), "maps_url" character varying(1024) NOT NULL, "comunaComunaId" integer, "userId" integer, "imageId" integer, CONSTRAINT "REL_360bfca1929d7a957a0bdf531a" UNIQUE ("imageId"), CONSTRAINT "PK_47a8d22be3f5018c8c2e3a10978" PRIMARY KEY ("academy_id"))`);
...
exports.DescriptionMigration1785786910255 = DescriptionMigration1785786910255;
//# sourceMappingURL=1785786910255-descriptionMigration.js.map